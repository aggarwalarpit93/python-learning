...
for question in questions:
    ...
    answer = int(input("Select your option. 1 for a / 2 for b / 3 for c / 4 for d\n"))
...
if correctAnswer:
    print(f"Your total earnings are: {prizes[correctAnswer-1]}")
else:
    print("You did not earn any money")
